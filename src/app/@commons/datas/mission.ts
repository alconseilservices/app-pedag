      ...
      indices: [
        {
          ...
          y: 41,
          // tslint:disable-next-line: max-line-length
          text: 'Le signal d\'alarme doit-être utilisé seulement en cas d\'urgence. En cas de malaise voyageur, il ne faut pas tirer le signal d’alarme mais appeler le 3117. Tout abus est passible d\'une amende',
          image: {
            file: 'S051',
            left: -373,
            top: -100,
