...
export const Mission1: MissionCourse = {
  ...
  steps: [
    ...
    },
    {
      ...
      docs: [
        {
          docTitle: 'Salle des commandes',
          docFile: 'M1-doc1.pdf',
          docExtension: 'application/pdf'
        },
        {
          docTitle: 'Salle des machines',
          docFile: 'M1-doc2.pdf',
          docExtension: 'application/pdf'
        },
        {
          docTitle: 'Transformateur',
          docFile: 'M1-doc3.pdf',
          docExtension: 'application/pdf'
        },
        {
          docTitle: 'Conduites forcées',
          docFile: 'M1-doc4.pdf',
          docExtension: 'application/pdf'
        },
        {
    ...
    },
    {
      ...
      conseils: [
        ...
        },
        {
          ...
          // tslint:disable-next-line: max-line-length
          goodToKnow: 'Les barrages sont surveillés en continu pour repérer les anomalies, analyser leur comportement et vérifier le bon fonctionnement des équipements.'
        },
        {
          name: 'Matheo',
          ...
          // tslint:disable-next-line: max-line-length
          goodToKnow: 'Chaque chantier doit être pensé pour ne pas avoir d’impact négatif sur l’environnement, les habitants, les animaux et les végétaux alentour.'
        }
      ]
    },
    {
      ...
      solutions: [
        {
          ...
          // tslint:disable-next-line: max-line-length
          solution: 'Il y a plein de jolis endroits près de la rivière pour s’installer et pique-niquer. Il faudra consulter la météo avant de partir, faire attention à bien s’installer dans une zone autorisée et ne pas s’approcher du bord pour éviter les glissades.',
          // tslint:disable-next-line: max-line-length
        ...
        },
        {
          ...
          // tslint:disable-next-line: max-line-length
          goodToKnow: 'Les zones interdites d’accès au public sont délimitées par une ligne de flotteurs à une distance d’environ 100m du barrage. Des panneaux danger peuvent indiquer que les berges sont dangereuses, qu’il y a un risque de glissade ou d’être emporté par un lâcher d’eau.',
          bg: 'S2.jpg',
          bgX: '-20px',
          bgY: '-20px',
